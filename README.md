...
This tileset is always up to date with content from the latest experimental versions of the game.
...
Put *Mods* folder in "Cataclysm Installation folder", **NOT**  in "Cataclysm Installation folder"/data. This way you can separate mods that are updated with the game, and mods you downloaded somewhere else that need to bee updated by hand.
